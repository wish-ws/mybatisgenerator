...
public class CustomAbstractXmlElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        find.addAttribute(new Attribute("id", "queryByObject"));
        ...
        list.addAttribute(new Attribute("id", "query" + introspectedTable.getFullyQualifiedTable().getDomainObjectName() + "List"));
        ...
        pageList.addAttribute(new Attribute("id", "query" + introspectedTable.getFullyQualifiedTable().getDomainObjectName() + "Page"));
        ...
        pageList.addElement(new TextElement("where 1=1"));
        pageList.addElement(new TextElement("limit #{offset}, #{pageSize}"));
